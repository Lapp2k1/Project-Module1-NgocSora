  ...
  data.forEach((product, i) => {
    stringHTML += `
      <tr>
        ...
        <td>
          ${`
            <button class="action-button update-button button-17" data-product-id="${
              product.id
            }">Update</button>
            <button class="action-button status-button button-17" data-product-id="${
              product.id
            }">${
            product.status === "available" ? "Unavailable" : "Available"
          }</button>
            <button class="action-button delete-button button-24" data-product-id="${
              product.id
            }">Delete</button>
          `}
        </td>
