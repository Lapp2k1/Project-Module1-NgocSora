  ...
  data.forEach((category, i) => {
    stringHTML += `
      <tr>
        ...
        <td>
          ${`
            <button class="action-button update-button button-17" data-category-id="${
              category.id
            }">Update</button>
            <button class="action-button status-button button-17" data-category-id="${
              category.id
            }">${
            category.status === "available" ? "Unavailable" : "Available"
          }</button>
            <button class="action-button delete-button button-24" data-category-id="${
              category.id
            }">Delete</button>
          `}
        </td>
